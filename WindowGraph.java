 ...
 * -------------------------------------------------------
 * Hàm tạo nhận hai tham số. Đầu tiên là ArrayList of ArrayLists của Số nguyên.
 *  ArrayList này chứa các đường được vẽ trên biểu đồ. Mỗi dòng là danh sách các giá trị.
 *   Tham số thứ hai là ArrayList of Strings đại diện cho Huyền thoại. Cả hai ArrayLists 
 * từ các tham số phải có cùng chiều dài. Không có ý nghĩa gì khi có nhiều vật phẩm trên
 *  Huyền thoại hơn có các Đường trên biểu đồ hoặc ngược lại 
 * <br/>
...
public class WindowGraph extends JFrame {
     ...
     * ----------------------------------------
     * * Theo mặc định, biểu đồ vẽ từng giá trị trên mỗi pixel. Ví dụ nếu
      * giá trị y là 10 thì nó sẽ được vẽ 10 pixel trên trục x.
      * Khi giá trị được nhập lớn hơn chiều rộng hoặc chiều cao của
      * cửa sổ này, tất cả các giá trị phải được thu nhỏ lại cho phù hợp. 
     */
     ...
     * @param yValues   the values to be plotted // các giá trị đc vẽ
     * @param legend    the the identifier of each set of values, // mã định danh của từng bộ giá trị
